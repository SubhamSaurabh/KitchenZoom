...
import MenuListCard from './../components/card/MenuListCard';
...
import getTomorrowsMenu from './../_services/dataService/importMenus';
...
class Dashbord extends Component {
    ...
    componentDidMount(){
        ...
        this.setState({loading:true}, ()=>{
            ...
            getTomorrowsMenu(token).then(res => {
                //console.log(res);
                if(res.status){
                ...
                <div style={{marginTop:"-30px"}}>
                            ...
                            this.state.meals.map((item, index) => {
                                return (
                                    <div key={index}>
                                        <Row >
                                            <Col xs="12">
                                                <MenuListCard Mydata={item} submitted={this.state.submitted}/>
                                            </Col>
                                        </Row>
                                        <Box size="20px"/>
                                    </div>
                    ...
                    <Row className="container">
                        <Col className="text-center">
                            <Button className="grey darken-3" style={{marginLeft:"40px", paddingLeft: "30%", paddingRight:"30%"}} disabled={this.state.loading} onClick={this.handleSubmit}>    
